...
def ConfigToNumElectrons(config, ignoreFullD = 0, ignoreFullF = 0):
    ...
    """
def GetAtomicData(atomDict, descriptorsDesired, dBase = 'C:/rdkit/build/temp.win-amd64-cpython-38/Release/rdkit_install\\share/RDKit\\Data\\atomdb.gdb', table = 'atomic_data', where = '', user = 'sysdba', password = 'masterkey', includeElCounts = 0):
    """
...
def SplitComposition(compStr):
    ...
    """
_atomDbName: str = 'C:/rdkit/build/temp.win-amd64-cpython-38/Release/rdkit_install\\share/RDKit\\Data\\atomdb.gdb'
